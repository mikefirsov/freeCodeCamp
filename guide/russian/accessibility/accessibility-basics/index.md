...
*   Если вы выделяете важную часть вашего сайта с определенным цветом, узнает ли об этом слепой человек?
*   Если вы добавляете на свой сайт изображения, которые передают важную информацию, как об этом может узнать узнать слепой или слабовидящий человек?
